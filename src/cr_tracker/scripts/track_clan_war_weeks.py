...
from cr_tracker.sql_scripts.sql_clans import get_clan_league, get_clan_trophy, get_valid_clans
from cr_tracker.sql_scripts.sql_war import insert_clan_stats_bulk, insert_player_weekly_fame_bulk
